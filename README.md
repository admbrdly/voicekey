...
- The normal dictation keys deliver into terminal Neovim through pinned buffers, including continuous dictation and inline previews, with the [Neovim plugin](contrib/nvim/README.md).
